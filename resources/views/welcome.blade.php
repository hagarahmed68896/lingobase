        ...
        <div class="hero-text-content">
            ...
            <div style="display: flex; gap: 1.25rem; flex-wrap: wrap;">
                @guest
                    ...
                    <a href="{{ route('grammar.placement') }}" class="btn" style="padding: 1.15rem 2.5rem; font-size: 1.1rem; border-radius: 3rem; background: var(--bg-card); color: var(--primary); border: 2px solid var(--border-color); font-weight: 700;">{{ __('messages.start_placement_test') }}</a>
                @else
                    ...
                    <a href="{{ route('grammar.placement') }}" class="btn" style="padding: 1.15rem 2.5rem; font-size: 1.1rem; border-radius: 3rem; background: var(--bg-card); color: var(--primary); border: 2px solid var(--border-color); font-weight: 700;">{{ __('messages.retake_assessment') }}</a>
                @endguest
            </div>
        </div>
