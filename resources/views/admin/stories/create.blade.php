...
<div style="max-width: 1000px; margin: 0 auto;">
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 2rem;">
        <div>
            <h1 style="font-size: 1.75rem; font-weight: 800; color: #111827; margin: 0;">Add New Story</h1>
            <p style="color: #6b7280; font-size: 0.95rem; margin: 0.25rem 0 0 0;">Create immersive reading content for your learners.</p>
        </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                <div style="background: white; padding: 2rem; border-radius: 1.5rem; border: 1px solid #e5e7eb; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <input type="text" name="title" class="search-input" style="width: 100%;" required placeholder="e.g. The Brave Little Engine">
                    </div>
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <textarea name="excerpt" class="search-input" style="width: 100%; height: 80px; line-height: 1.5;" placeholder="A brief hook for the story..."></textarea>
                    </div>

                    <div style="margin-bottom: 1.5rem;">
                        <label style="display: block; font-size: 0.85rem; font-weight: 700; color: #4b5563; margin-bottom: 0.5rem;">Full Story Body</label>
                        <textarea name="content" class="search-input" style="width: 100%; height: 400px; line-height: 1.7; resize: vertical;" required placeholder="Once upon a time..."></textarea>
                    </div>
                </div>
                ...
                <div style="background: #fffbeb; padding: 2rem; border-radius: 1.5rem; border: 1px solid #fde68a; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
                    ...
                    <p style="color: #b45309; font-size: 0.85rem; margin: -1rem 0 1.5rem 0;">Provide translations for difficult words or summarize plot points in Arabic.</p>
                    
                    <textarea name="arabic_comment" class="search-input" style="width: 100%; height: 200px; direction: rtl; line-height: 1.8; border-color: #fde68a;" placeholder="أضف تعليقات أو معاني كلمات صعبة باللغة العربية..."></textarea>
                </div>
            </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                <div style="background: white; padding: 2rem; border-radius: 1.5rem; border: 1px solid #e5e7eb; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <input type="text" name="slug" class="search-input" style="width: 100%; font-family: monospace;" required placeholder="story-title-slug">
                    </div>

                    <div style="margin-bottom: 1.5rem;">
                        <label style="display: block; font-size: 0.85rem; font-weight: 700; color: #4b5563; margin-bottom: 0.5rem;">Image URL</label>
                        <input type="url" name="image_url" class="search-input" style="width: 100%;" placeholder="https://example.com/cover.jpg">
                    </div>
                    ...
                    <div style="margin-bottom: 2rem;">
                        ...
                        <input type="url" name="audio_url" class="search-input" style="width: 100%;" placeholder="https://example.com/narrative.mp3">
                    </div>
                ...
                <div style="background: white; padding: 1.5rem; border-radius: 1.5rem; border: 1px dashed #d1d5db; text-align: center;">
                    <div style="font-size: 0.8rem; color: #6b7280; line-height: 1.5;">
                        <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="margin: 0 auto 0.5rem; display: block; color: #9ca3af;"><path d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        Users can favorite stories and track their reading progress in their profiles.
                    </div>
                </div>
            </div>
        </div>
