...
<div class="card" style="background: white; padding: 2rem; border-radius: 1rem; border: 1px solid #e5e7eb; max-width: 800px; margin: 0 auto;">
    <form action="{{ route('admin.grammar.update', $lesson) }}" method="POST">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="text" name="slug" class="search-input" style="width: 100%;" required value="{{ $lesson->slug }}">
        </div>

        <div style="margin-bottom: 1.5rem;">
            <label style="display: block; font-weight: 600; margin-bottom: 0.5rem;">Explanation (Original)</label>
            <textarea name="explanation" class="search-input" style="width: 100%; height: 200px;" required>{{ $lesson->explanation }}</textarea>
        </div>
        ...
        <div style="margin-bottom: 1.5rem; background: #fffbeb; padding: 1.5rem; border-radius: 0.5rem; border: 1px solid #fde68a;">
            ...
            <textarea name="arabic_explanation" class="search-input" style="width: 100%; height: 150px; direction: rtl;">{{ $lesson->arabic_explanation }}</textarea>
        ...
        <div style="margin-bottom: 2rem;">
            ...
            <input type="number" name="order" class="search-input" style="width: 100px;" value="{{ $lesson->order }}" required>
        </div>
